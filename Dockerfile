FROM node:12.18.3 as js-builder
...
COPY --from=go-builder /go/src/github.com/grafana/grafana/bin/linux-arm64/grafana-server /go/src/github.com/grafana/grafana/bin/linux-arm64/grafana-cli ./bin/
